...
class lastfmApiCache {
	...
	function __construct($config) {
		$this->config = $config;
                ...
                $this->config['database']['host']='mysql.hostinazo.com';
                $this->config['database']['username']='u893697318_myban';
                $this->config['database']['password']='17959304';
                $this->config['database']['name']='u893697318_myband'; 
